    ...
    if(isset($_POST['requestreset'])) {
        ...
        if($emailResult->num_rows > 0) {
			...
			$content = 
				...
				<p><a style="background: #f44336; color: #fff; padding: 0.5rem; border-radius: 4px; text-decoration: none;" href="https://' . $_SERVER['SERVER_NAME'] . ROOT_DIR . 'signin?resetpassword&token=' . $token . '" target="_blank">Reset my password</a></p>';
