        ...
        if(!$settings || !file_exists($template)) {
            ...
            if($mysqli->connect_error) {
                ...
                $queries = [
                    ...
                    "INSERT IGNORE INTO `posts` (id, post_type_id, name, content, url, author, state) VALUES(1, 1, 'Welcome', '<h1>Welcome to Setsquare CMS</h1><p>Set up is complete, you can now start creating content.</p>', '.', 'Admin User', 2)",
                    //Comments
